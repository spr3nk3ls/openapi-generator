...
:bangbang: Both OpenAPITools.org (the parent organization of OpenAPI Generator) and OpenAPI Generator are not affiliated with OpenAPI Initiative (OAI) :bangbang:
